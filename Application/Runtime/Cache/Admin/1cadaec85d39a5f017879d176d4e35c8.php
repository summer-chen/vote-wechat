                        ...
                        <table class="table table-bordered data-table">
                            ...
                            <tbody>
                                ...
                                <tr id="row<?php echo $v['cid']; ?>">
                                    ...
                                    <td>
                                        <a class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick="record('<?php echo $v['cid']; ?>')">查看支持记录</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-content nopadding">
                                <form id="carousel">
                                    <table id="record_table" class="table table-bordered data-table">
                                    </table>
                                </form>
                            </div>
                        </div>
...
<script type="text/javascript" src="/vote/Public/Admin/script/jquery-1.7.1.min.js" ></script>
<script type="text/javascript" src="/vote/Public/Admin/script/competitor.js"></script>
<script type="text/javascript" src="/vote/Public/Admin/script/cypager.min.js" ></script>
<script><!--
$(function(){
